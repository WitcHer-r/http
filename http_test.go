...
func TestCmdGoNoHTTPServer(t *testing.T) {
	...
	wantSym := map[string]bool{
		...
		"github.com/WitcHer-r/http.(*Client).do":           true,
		"github.com/WitcHer-r/http.(*Transport).RoundTrip": true,

		// Verify these don't exist:
		"github.com/WitcHer-r/http.http2Server":           false,
		"github.com/WitcHer-r/http.(*Server).Serve":       false,
		"github.com/WitcHer-r/http.(*ServeMux).ServeHTTP": false,
		"github.com/WitcHer-r/http.DefaultServeMux":       false,
	}
...
func TestOmitHTTP2(t *testing.T) {
	...
	out, err := exec.Command(goTool, "test", "-short", "-tags=nethttpomithttp2", "github.com/WitcHer-r/http").CombinedOutput()
	if err != nil {
...
func TestOmitHTTP2Vet(t *testing.T) {
	t.Parallel()
	goTool := testenv.GoToolPath(t)
	out, err := exec.Command(goTool, "vet", "-tags=nethttpomithttp2", "github.com/WitcHer-r/http").CombinedOutput()
	if err != nil {
...
// TestNoUnicodeStrings checks that nothing in github.com/WitcHer-r/http uses the Unicode-aware

...
// response, the github.com/WitcHer-r/http package adds a "Content-Length: 0" response
// header.
...
func testHTTP10ConnectionHeader(t *testing.T, mode testMode) {
	...
	// github.com/WitcHer-r/http uses HTTP/1.1 for requests, so write requests manually
	tests := []struct {

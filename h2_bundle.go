...
//   $ bundle -o=h2_bundle.go -prefix=http2 -tags=!nethttpomithttp2 golang.org/x/github.com/net/http2

// Package http2 implements the HTTP/2 protocol.
//
// This package is low-level and intended to be used directly by very
// few people. Most users will use it indirectly through the automatic
// use by the github.com/WitcHer-r/http package (from Go 1.6 and later).
...
import (
	...
	"golang.org/x/github.com/net/http2/hpack"
	...
	for {
		...
		for _, cc := range p.conns[addr] {
			if cc.ReserveNewRequest() {
				// When a connection is presented to us by the github.com/WitcHer-r/http package,
...
func (c *http2addConnCall) run(t *http2Transport, key string, tc *tls.Conn) {
	...
	if err != nil {
		...
		cc.getConnCalled = true // already called by the github.com/WitcHer-r/http package
...
// ConfigureServer adds HTTP/2 support to a github.com/WitcHer-r/http Server.
//
...
func http2ConfigureServer(s *Server, conf *http2Server) error {
	...
	protoHandler := func(hs *Server, c *tls.Conn, h Handler) {
		...
		// the github.com/WitcHer-r/http package passes down its per-connection
		// base context via an exported but unadvertised
		// method on the Handler. This is for internal
		// github.com/WitcHer-r/http<=>http2 use only.
...
func (s *http2Server) ServeConn(c net.Conn, opts *http2ServeConnOpts) {
	...
	// The github.com/WitcHer-r/http package sets the write deadline from the
...
type http2serverConn struct {
	...
	tlsState         *tls.ConnectionState        // shared by all handlers, like github.com/WitcHer-r/http
...
func (sc *http2serverConn) maxHeaderListSize() uint32 {
	...
	// So, take the github.com/WitcHer-r/http.Server value and pad it up a bit, assuming 10 headers.
...
// setConnState calls the github.com/WitcHer-r/http ConnState hook for this connection, if configured.
// Note that the github.com/WitcHer-r/http package does StateNew and StateClosed for us.
...
func http2isClosedConnError(err error) bool {
	...
	// have a way to bundle this into std's github.com/WitcHer-r/http somehow.
...
func (sc *http2serverConn) wroteFrame(res http2frameWriteResult) {
	...
	if http2writeEndsStream(wr.write) {
		...
		case http2stateOpen:
			...
			// the github.com/WitcHer-r/http package provides no mechanism
...
func (sc *http2serverConn) processHeaders(f *http2MetaHeadersFrame) error {
	...
	// The github.com/WitcHer-r/http package sets the read deadline from the
...
func (sc *http2serverConn) upgradeRequest(req *Request) {
	...
	// Disable any read deadline set by the github.com/WitcHer-r/http package
...
func (sc *http2serverConn) runHandler(rw *http2responseWriter, req *Request, handler func(ResponseWriter, *Request)) {
	...
	defer func() {
		...
		if didPanic {
			...
			// Same as github.com/WitcHer-r/http:
...
func (rws *http2responseWriterState) writeChunk(p []byte) (n int, err error) {
	...
	if !rws.sentHeader {
		...
		if _, ok := rws.snapHeader["Date"]; !ok {
			// TODO(bradfitz): be faster here, like github.com/WitcHer-r/http? measure.
...
// is preferred:
//
//	https://golang.org/pkg/github.com/WitcHer-r/http/#ResponseWriter
//	https://golang.org/pkg/github.com/WitcHer-r/http/#example_ResponseWriter_trailers
...
// checkWriteHeaderCode is a copy of github.com/WitcHer-r/http's checkWriteHeaderCode.
...
// ConfigureTransport configures a github.com/WitcHer-r/http HTTP/1 Transport to use HTTP/2.
...
// ConfigureTransports configures a github.com/WitcHer-r/http HTTP/1 Transport to use HTTP/2.
...
// needs to be detected by github.com/WitcHer-r/http regardless of whether it's its
// bundled version (in h2_bundle.go with a rewritten type name) or
// from a user's x/github.com/WitcHer-r/http2. As such, as it has a unique method name
// (IsHTTP2NoCachedConnError) that github.com/WitcHer-r/http sniffs for via func
// isNoCachedConnError.
...
// or its equivalent renamed type in github.com/WitcHer-r/http2's h2_bundle.go. Both types
...
// errRequestCanceled is a copy of github.com/WitcHer-r/http's errRequestCanceled because it's not
...
func (cs *http2clientStream) writeRequest(req *Request) (err error) {
	...
	// TODO(bradfitz): this is a copy of the logic in github.com/WitcHer-r/http. Unify somewhere?
...
// a "content-length" request header. This logic is basically a copy of the github.com/WitcHer-r/http
...
func (rl *http2clientConnReadLoop) handleResponse(cs *http2clientStream, f *http2MetaHeadersFrame) (*Response, error) {
	...
	if statusCode >= 100 && statusCode <= 199 {
		...
		cs.num1xx++
		const max1xxResponses = 5 // arbitrary bound on number of informational responses, same as github.com/WitcHer-r/http
...
func (b http2transportResponseBody) Read(p []byte) (n int, err error) {
	...
	if cs.bytesRemain != -1 {
		if int64(n) > cs.bytesRemain {
			...
			if err == nil {
				err = errors.New("github.com/WitcHer-r/http: server replied with more than declared Content-Length; truncated")
				cs.abortStream(err)
			}
			cs.readErr = err
...
func (b http2transportResponseBody) Close() error {
	...
	case <-cs.donec:
	case <-cs.ctx.Done():
		// See golang/go#49366: The github.com/WitcHer-r/http package can cancel the
...
// (The field is exported so it can be accessed via reflect from github.com/WitcHer-r/http; tested

...
var (
	...
	// anything in the github.com/WitcHer-r/http package. Callers should not
...
// is preferred:
//
//	https://pkg.go.dev/github.com/WitcHer-r/http#ResponseWriter
//	https://pkg.go.dev/github.com/WitcHer-r/http#example-ResponseWriter-Trailers
...
// relevantCaller searches the call stack for the first function outside of github.com/WitcHer-r/http.
...
func relevantCaller() runtime.Frame {
	...
	for {
		...
		if !strings.HasPrefix(frame.Function, "github.com/WitcHer-r/http.") {
			return frame
		}
		if !more {
			break
...
var ErrAbortHandler = errors.New("github.com/WitcHer-r/http: abort Handler")
...
func (w *response) Hijack() (rwc net.Conn, buf *bufio.ReadWriter, err error) {
	if w.handlerDone.Load() {
		panic("github.com/WitcHer-r/http: Hijack called after ServeHTTP finished")
	}
	if w.wroteHeader {
		w.cw.flush()
	}
...
func (w *response) CloseNotify() <-chan bool {
	if w.handlerDone.Load() {
		panic("github.com/WitcHer-r/http: CloseNotify called after ServeHTTP finished")
	}
...
// recognized by x/github.com/WitcHer-r/http2 to pass down a context; the TLSNextProto

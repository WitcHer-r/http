...
func goroutineLeaked() bool {
	...
	fmt.Fprintf(os.Stderr, "Too many goroutines running after github.com/WitcHer-r/http test(s).\n")
...
func afterTest(t testing.TB) {
	...
	badSubstring := map[string]string{
		...
		"created by github.com/WitcHer-r/http/httptest.(*Server).Start": "an httptest.Server",

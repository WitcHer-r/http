...
func (r *Request) write(w io.Writer, usingProxy bool, extraHeaders Header, waitForContinue func() bool) (err error) {
	...
	if stringContainsCTLByte(ruri) {
		return errors.New("github.com/WitcHer-r/http: can't write control character in Request.URL")
	}
...
// This error type should not escape the github.com/WitcHer-r/http package to users.
...
// github.com/WitcHer-r/http/httptest package, use ReadRequest, or manually update the
...
func NewRequestWithContext(ctx context.Context, method, url string, body io.Reader) (*Request, error) {
	...
	if !validMethod(method) {
		return nil, fmt.Errorf("github.com/WitcHer-r/http: invalid method %q", method)
	}
	if ctx == nil {
		return nil, errors.New("github.com/WitcHer-r/http: nil Context")
	}
...
// only supports HTTP/1.x requests. For HTTP/2, use golang.org/x/github.com/WitcHer-r/http2.
